...
export const collectionsApi = {
  ...
  update: (id: string, data: { name?: string; description?: string; isDefault?: boolean; sortOrder?: number; difficulty?: string; parentCollectionId?: string | null }) =>
...
export const coursesApi = {
  ...
  createAndAddCollection: (courseId: string, data: { name: string; description?: string; difficulty?: string; sourceCollectionId?: string }) =>
